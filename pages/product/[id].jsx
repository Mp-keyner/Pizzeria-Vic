...
const Product = () => {
    ...
    const pizza = {
        id: 1,
        img: '/img/pizza-Product.jpg',
        name: 'CAMPAGNOLA',
        price: [19.9, 23.9, 27.9],
        desc: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laboriosam aspernatur quod fugiat provident ipsam enim, illo autem facilis fugit voluptatum incidunt tempora error porro blanditiis"
    }
    return (
